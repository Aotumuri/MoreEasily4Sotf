...
execute as @e[type=potion,nbt={Item:{id:"minecraft:splash_potion",count:1,components:{"minecraft:potion_contents":{custom_color:16725526}}}}] at @s run function mefours:superprotectionoflamp_attack
